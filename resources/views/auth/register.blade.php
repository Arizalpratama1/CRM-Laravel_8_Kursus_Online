               ...
               <div class="auth-wrapper auth-v2">
                  <div class="auth-inner row m-0">
                     ...
                     <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                        <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="{{ asset('vuexy/images/pages/register-v2-dark.svg') }}" alt="Login V2"></div>
                     </div>
                     <!-- /Left Text-->
                     <!-- Login-->
                           ...
                           <form method="POST" action="{{ route('register') }}">
                            @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="phone" type="number" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required autocomplete="phone" placeholder="Phone Active Exp.(087667345654)">
                                        @error('phone')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                              ...
                              <button class="btn btn-primary btn-block waves-effect waves-float waves-light" type="submit" tabindex="4">Register</button>
                           </form>
                        </div>
                     </div>
