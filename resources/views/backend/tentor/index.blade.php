    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-3 form-group">
                <a href="{{ url('/admin/tentor/create') }}" type="button" class="btn btn-outline-primary waves-effect waves-float waves-light">
...
<script>
    $(function(){
        var table = $('.datatable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{ url("/admin/tentor") }}',
                type: 'GET',
                headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') }
            },
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'nama_tentor', name: 'nama_tentor'},
