...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('vuexy') }}/css/pages/app-ecommerce.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('vuexy') }}/css/pages/app-ecommerce.min.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('vuexy') }}/css/pages/app-ecommerce-shop.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('vuexy') }}/css/pages/app-ecommerce-shop.min.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static" data-open="click" data-menu="vertical-menu-modern" data-col="">
                ...
                <li class="nav-item dropdown dropdown-user">
                    <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none">
                            ...
                            <span class="user-status">{{ Auth::user()->level->nama_level }}</span>
                        </div>
                        <span class="avatar">
                            <img class="round" src="{{ url('vuexy/images/portrait/small/avatar-s-11.jpg') }}" alt="avatar" height="40" width="40">
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="/"><span class="brand-logo">
                        ...
                        <h2 class="brand-text">Creative Academy</h2>
                    </a></li>
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2022<a class="ml-25" href="https://creativemedia.id/">CV. Creative Media</a><span class="d-none d-sm-inline-block">, All rights Reserved</span></span><span class="float-md-right d-none d-md-block">Hand-crafted & Made with<i data-feather="heart"></i></span></p>
    </footer>
    ...
    <script src="{{ asset('vuexy') }}/js/scripts/pages/app-ecommerce.js"></script>
    <script src="{{ asset('vuexy') }}/js/scripts/pages/app-ecommerce.min.js"></script>
    <script src="{{ asset('vuexy') }}/js/scripts/pages/app-ecommerce-shop.js"></script>
    <script src="{{ asset('vuexy') }}/js/scripts/pages/app-ecommerce-shop.min.js"></script>
